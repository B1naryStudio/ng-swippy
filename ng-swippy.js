	...
	directive('ngSwippy', ['swipe', function(swipe){
		return {
			...
			template: 	'<div class="ng-swippy">'+
							'<div person="person" style="width: {{width}}; height: {{height}}" swipe-directive="swipe-directive" ng-repeat="person in collection" class="content-wrapper swipable-card">' +
  								'<div class="card">' +
